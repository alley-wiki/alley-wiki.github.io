...
const faqs = [
  ...
  },
  {
    ...
    answer: "Если вы заметили нарушение правил, сообщите об этом модераторам или администраторам сервера через пинг. Например: @Полиция Аллей [Модераторы] или же @миса | владелец."
  }
]
